...
export default function EditBar({role}) {
    ...
    <div>
        ...
        <div className='grid sm:grid-cols-2 lg:grid-cols-3'>
            ...
            {/* {console.log(userid)} */}
            <div className=' m-5 mt-0 sm:mt-5 h-20 bg-primary-green hover:bg-hover-green rounded-xl cursor-pointer flex items-center justify-center gap-3' onClick={() => navigate(`/profile/${User.userID}`)}>
